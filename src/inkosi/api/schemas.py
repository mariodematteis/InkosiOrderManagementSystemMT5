...
class OpenRequestTradeResult:
    ...
    Attributes:
        ...
        status (StatusTradeResult): The status of the trade result, indicating success
        or failure.
        trade_id (int, optional): The ID of the opened trade, if successful.
        deal_id (int, optional): The ID of the deal associated with the opened trade,
        if successful.
...
class CloseRequestTradeResult:
    ...
    Attributes:
        ...
        status (StatusTradeResult): The status of the trade result, indicating success
        or failure.
        profit (float, optional): The profit obtained from closing the trade, if
        successful.
